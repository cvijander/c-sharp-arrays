...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        */
        ...
        int[] niz = GenerisiNiz(10, 1, 56);
        StampajClanoveNiza(niz);
    }
    ...
    public static int[] GenerisiNiz(int duzinaNiza, int najmanjaVrednost, int najvecaVrednost)
    {
        ...
        {
            niz[i] = r.Next(najmanjaVrednost, najvecaVrednost);
        }
        return niz;
    }
